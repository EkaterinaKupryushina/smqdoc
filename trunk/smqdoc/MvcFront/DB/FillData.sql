...
INSERT INTO [smqdoc].[dbo].[FieldTemplates]
           ...
           ,[OperationType])
     VALUES
          ('Поле номер шаблон номер 1',0,0,NULL,NULL,1,1,0,0),
		   ('Поле номер шаблон номер 2',1,1,10,1,1,2,2,0),
		   ('Поле номер шаблон номер 3',2,0,NULL,NULL,1,3,0,0),
		   ('Поле номер шаблон номер 4',1,0,NULL,NULL,1,4,1,0),
		   ('Поле номер шаблон номер 5',1,0,NULL,NULL,1,5,0,0),
		   ('Поле номер шаблон номер 6',1,0,NULL,NULL,1,6,0,0),
		   ('Поле номер шаблон номер 7',1,0,NULL,NULL,1,7,0,0),
		   ('Поле номер шаблон номер 8',0,0,NULL,NULL,2,1,0,0),
		   ('Поле номер шаблон номер 9',0,0,NULL,NULL,2,2,0,0),
		   ('Поле номер шаблон номер 10',0,0,NULL,NULL,2,3,0,0),
		   ('Поле номер шаблон номер 11',2,0,NULL,NULL,3,1,0,0),
		   ('Поле номер шаблон номер 12',2,0,NULL,NULL,4,1,0,0),
		   ('Поле номер шаблон номер 13',1,0,NULL,NULL,4,2,0,0),
		   ('Поле номер шаблон номер 14',1,0,NULL,NULL,4,3,0,0),
		   ('Поле номер шаблон номер 15',1,0,NULL,NULL,4,4,0,0),
		   ('Поле номер шаблон номер 16',1,0,NULL,NULL,4,5,0,0),
		   ('Поле номер шаблон номер 17',0,0,NULL,NULL,4,6,0,0)
GO
GO
